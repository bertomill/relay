  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-[#1C1C1C] relative overflow-x-hidden">
      ...
      <section className="relative">
        <div className="max-w-6xl mx-auto px-6 pt-16 pb-20 md:pt-24 md:pb-28 lg:pt-32 lg:pb-36">
          <AnimateIn animation="fade-up">
            <p className="text-xs font-semibold text-[#6B8F71] uppercase tracking-[0.15em] mb-6">
              Fractional AI Officer for Shopify
            </p>
          </AnimateIn>
          <AnimateIn animation="fade-up" delay={50}>
            <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl leading-[1.05] tracking-tight mb-8 max-w-4xl">
              Scale your store<br className="hidden md:block" /> with AI.{" "}
              <span className="italic text-[#6B8F71]">Not more headcount.</span>
            </h1>
          </AnimateIn>
          <AnimateIn animation="fade-up" delay={100}>
            <p className="text-lg md:text-xl text-[#555] leading-relaxed mb-10 max-w-2xl">
              We embed as your fractional AI officer — building content engines, customer support bots, marketing automation, and operations intelligence custom-built for your Shopify store.
            </p>
          </AnimateIn>
          <AnimateIn animation="fade-up" delay={150}>
            <div className="flex flex-wrap items-center gap-4">
              <a
                href="#contact"
                className="bg-[#1C1C1C] text-white text-sm font-semibold tracking-[0.1em] uppercase px-8 py-4 rounded-full hover:bg-[#333] transition-colors duration-200"
              >
                GET STARTED
              </a>
              <Link
                href="/offer"
                className="border border-[#1C1C1C] text-[#1C1C1C] text-sm font-semibold tracking-[0.1em] uppercase px-8 py-4 rounded-full hover:bg-[#1C1C1C] hover:text-white transition-colors duration-200"
              >
                HOW IT WORKS
              </Link>
            </div>
            ...
            <div className="max-w-6xl mx-auto px-6 py-20 md:py-28">
              <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <AnimateIn animation={isReversed ? "slide-right" : "slide-left"} delay={100} className={isReversed ? "lg:order-1" : ""}>
                  <div className="bg-[#1C1C1C] rounded-2xl p-10 md:p-14 flex flex-col items-center justify-center aspect-[4/3] max-w-lg mx-auto relative overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-[#6B8F71]/20 to-transparent" />
                    <svg className="w-16 h-16 text-[#6B8F71] relative z-10 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1}>
                      <path strokeLinecap="round" strokeLinejoin="round" d={feature.icon} />
                    </svg>
                    <p className="text-white/40 text-sm uppercase tracking-[0.15em] relative z-10">{feature.label}</p>
                  </div>
                </AnimateIn>
              </div>
            </div>
