export interface PlatformMeta {
  ...
  url: string;
  iconPath: string;
  /** true = uses stroke-based icon, false = fill-based */
  stroke?: boolean;
}
...
export const PLATFORMS: Record<string, PlatformMeta> = {
  ...
  medium: {
    ...
    name: "Medium",
    handle: "@LightenAI",
    url: "https://medium.com/@LightenAI",
    iconPath:
  ...
  linkedin: {
    ...
    name: "LinkedIn",
    handle: "Lighten AI",
    url: "https://linkedin.com/company/lightenai",
    iconPath:
  ...
  instagram: {
    ...
    name: "Instagram",
    handle: "@lightenai",
    url: "https://instagram.com/lightenai",
    iconPath:
  ...
  youtube: {
    ...
    name: "YouTube",
    handle: "@LightenAI",
    url: "https://youtube.com/@LightenAI",
    iconPath:
